...
trait ServiceSubscriberTrait
{
    ...
    public static function getSubscribedServices() : array
    {
        ...
        $services = \is_callable(['Modular\\ConnectorDependencies\\parent', __FUNCTION__]) ? parent::getSubscribedServices() : [];
    ...
    public function setContainer(ContainerInterface $container)
    {
        ...
        if (\is_callable(['Modular\\ConnectorDependencies\\parent', __FUNCTION__])) {
